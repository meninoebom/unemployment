...
unemploymentApp.controller('Level1Ctrl', ['$scope', function($scope) {
    ...
    $scope.profiles = [
      ...
      {gender: "f", failedAttempts: 0, name: "Greg", description: "volunteers 30 hours a week in a local soup kitchen", employmentCategoryId: 5, active: "true"},
      ...
      {gender: "f", failedAttempts: 0, name: "Julie", description: "recently graduated from college with a degree in Marketing and is now sending out resumes in hopes of finding a job", employmentCategoryId: 2, active: "true"},
      ...
      {gender: "f", failedAttempts: 0, name: "Kayla", description: "stopped looking for work two weeks ago after sending her resume out of 30 potential employers and only receiving one interview (in which she did not receive a job offer)", employmentCategoryId: 5, active: "true"},
      {gender: "f", failedAttempts: 0, name: "Bonnie", description: "owns her business . She worked 40 hours last week but did not receive a paycheck", employmentCategoryId: 1, active: "true"},
